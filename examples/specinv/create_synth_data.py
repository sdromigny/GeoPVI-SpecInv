...
prior_bounds = np.loadtxt('/home/sixtine/Documents/SANT/GeoPVI-SpecInv/examples/specinv/input_new/prior_20_top.txt')
...
np.save("/home/sixtine/Documents/SANT/GeoPVI-SpecInv/examples/specinv/input_new/A_matrix.npy",A)
...
out_dir = "/home/sixtine/Documents/SANT/GeoPVI-SpecInv/examples/specinv/input_new/spectra_nodes"
...
plt.savefig("results/synth_spec.png")
...
plt.xlabel("x index")
plt.ylabel("y index")
plt.savefig("results/coverage_map.png")
...
plt.savefig("results/pair_counts.png")
...
plt.savefig("results/A_kernels.png")
